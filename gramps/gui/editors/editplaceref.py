...
from ..widgets.placetypeselector import (
    update_placetypes, prep_placetype_list_for_edit, PlaceTypeSelector)
...
from gramps.gen.lib import NoteType, PlaceGroupType, PlaceType, PlaceName
...
class EditPlaceRef(EditReference):
    ...
    def _setup_fields(self):
        ...
        prep_placetype_list_for_edit(self.db, self.source)
        self.place_type = PlaceTypeSelector(self.db,
    ...
    def update_type(self):
        """ Updaate the combo when type is changed """
        if self.place_type:
    ...
    def save(self, *obj):
        ...
        # fix up placetype list and save any new placetypes to db
        update_placetypes(self.db, self.source)
