...
from gramps.gui.widgets.placetypeselector import (
...
class PlaceSidebarFilter(SidebarFilter):
    ...
    def __init__(self, dbstate, uistate, clicked):
        ...
        prep_placetype_list_for_edit(self.dbstate.db, self.filter_place)
        self.place_type = PlaceTypeSelector(self.dbstate.db,
                                            self.ptype,
                                            self.filter_place.type_list[0],
                                            sidebar=True)
